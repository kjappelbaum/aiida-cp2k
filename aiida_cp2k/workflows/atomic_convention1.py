...
spin = {
    ...
    "Zn": 0.0,
    "Zr": 2.0 / 2.0,
    "Ce": 0.0 / 2.0,  # oxidation state +4 [Xe] 4f1 5d1 6s2
    "Y": 0.0 / 2.0,  # oxidation state +3 [Kr] 4d1 5s2
    "Eu": 7.0 / 2.0,  # oxidation state +3 [Xe] 4f7 6s2
    "Hf": 0.0 / 2.0,  # oxidation state +4 4f14 5d2 6s2
    "In": 0.0 / 2.0,  # oxidation state +3 [Kr] 4d10 5s2 5p1
    "La": 0.0 / 2.0,  # oxidation state +3 [Xe] 5d1 6s2
    "Ga": 0.0 / 2.0,  # oxidation state +3 [Ar] 3d10 4s2 4p1
    "Tb": 6.0 / 2.0,  # oxidation state +3 [Xe] 4f9 6s2
    "Gd": 7.0 / 2.0,  # oxidation state +3  4f7 5d1 6s2
    "W": 0.0 / 2.0,  # oxidation state +6
}
